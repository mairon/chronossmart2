<% if @revisao_result.tipo_id == 1 or  @revisao_result.tipo_id == 17 %>
<?xml version="1.0"?>
  ...
  <Worksheet ss:Name="Sheet1">
    ...
    <% @amostras.each do |a| %>
      ...
      <Row>
        ...
        <% if calcio != nil %>
         <Cell ss:StyleID="2"><Data ss:Type="String"><%= resul_sat_base = (((calcio.resultado.to_f + magnesio.resultado.to_f + potasio.resultado.to_f) * 100) / ( (calcio.resultado.to_f + magnesio.resultado.to_f + potasio.resultado.to_f) + h_aluminio_result.to_f)).round(2)  %>
          </Data></Cell>
        <% else %>
          <Cell ss:StyleID="2"><Data ss:Type="String">NS</Data></Cell>
        <% end %>
...
<% elsif @revisao_result.tipo_id == 6 %>
...
<% elsif @revisao_result.tipo_id == 14 %>
  <%= render 'laudo_xls_gn' %>
<% end %>
