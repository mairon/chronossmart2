  ...
  describe '#execute' do
    context 'when pass valid params' do
      it 'sends file' do
        ...
        result = described_class.new(telephone: telephone, filepath: filepath, title: title).execute
    ...
    context 'raises errors' do
      it 'when returns error in response body' do
        ...
        expect do
          described_class.new(telephone: telephone, filepath: filepath, title: title).execute
